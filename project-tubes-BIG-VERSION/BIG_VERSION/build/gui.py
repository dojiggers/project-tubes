...
def listWeatherIcon(n):
    ...
    print(f"INI KONDISI CUACA NYA KOLOM ATAS KIRI KE 5 {cuacatxt}")
    return cuacatxt
    #print(list_weather_icon[n])

def kolomatasF():
    # canvas.itemconfig(kolomataske1Waktu, text=listWaktu(0))
    # canvas.itemconfig(kolomataske1Temp, text=listTemperature(0))
    # canvas.itemconfig(kolomataske2Waktu, text=listWaktu(1))
    # canvas.itemconfig(kolomataske2Temp, text=listTemperature(1))
    # canvas.itemconfig(kolomataske2Waktu, text=listWaktu(1))
    # canvas.itemconfig(kolomataske2Temp, text=listTemperature(1))
    # canvas.itemconfig(kolomataske3Waktu, text=listWaktu(2))
    # canvas.itemconfig(kolomataske3Temp, text=listTemperature(2))
    # canvas.itemconfig(kolomataske4Waktu, text=listWaktu(3))
    # canvas.itemconfig(kolomataske4Temp, text=listTemperature(3))
    canvas.itemconfig(kolomataske5Waktu, text=listWaktu(4))
    canvas.itemconfig(kolomataske5Temp, text=listTemperature(4))


def kolomatasF2():
    # canvas.itemconfig(kolomataske1Waktu, text=" ")
    # canvas.itemconfig(kolomataske1Suhu, text=" ")
    # canvas.itemconfig(kolomataske2Waktu, text=" ")
    # canvas.itemconfig(kolomataske2Suhu, text=" ")
    # canvas.itemconfig(kolomataske2Waktu, text=" ")
    # canvas.itemconfig(kolomataske2Suhu, text=" ")
    # canvas.itemconfig(kolomataske3Waktu, text=" ")
    # canvas.itemconfig(kolomataske3Suhu, text=" ")
    # canvas.itemconfig(kolomataske4Waktu, text=" ")
    # canvas.itemconfig(kolomataske4Suhu, text=" ")
...
def mintaReq():
    global request_url,response,weather,weatherIcon,temperature,pressure,humidity,cuaca_sekarang, temperatur_sekarang, tekanan_sekarang,kelembaban_sekarang,image_27,copyright,itk,notfound0,notfound1,notfound2,notfound3,kolomataske5Waktu,kolomataske5Temp,list,image_image_16,image_6 
    try:
        hpusMarkError()
    except NameError:
    ...
    #kelembaban hari ini
        ...
        #Paling Kiri 3 Kolom Atas
        listWaktu(2)
        listWeatherIcon(2)
        listTemperature(2)

        #Paling Kiri 4 Kolom Atas
        
        listWaktu(3)
        listWeatherIcon(3)
        listTemperature(3)

        #Paling Kiri 5 Kolom Atas
